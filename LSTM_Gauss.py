...
def main():
    for rnn_dim in [256]:
        for count in np.arange(500):
            pkl_name = 'LSTM_hidden{}_{}'.format(rnn_dim, count)
            ...
            if count == 0:
                pkl_path = './models/LSTM_hidden{}.pkl'.format(rnn_dim)
            else:
                pkl_path = './models/LSTM_hidden{}_{}.pkl'.format(rnn_dim, (count - 1))
            ...
            [rnn, x_1, x_2, theta_1, theta_2, theta_mu, theta_sig] = nodes
