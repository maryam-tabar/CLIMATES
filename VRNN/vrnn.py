...
def main(args):
    for rnn_dim in [256]:
        for count in np.arange(420, 500):
            cluster_id = 51
            pkl_name = 'VRNN_cluster{}_hidden{}_{}'.format(cluster_id, rnn_dim, count)
            npp_path = './datasets/npp_cluster{}.npy'.format(cluster_id)
            save_path = './models/'
            monitoring_freq = 1
            force_saving_freq = 1
            epoch = 1
            ...
            if count == 0:
                pkl_path = './models/VRNN_cluster{}_hidden{}.pkl'.format(cluster_id, rnn_dim)
            else:
                pkl_path = './models/VRNN_cluster{}_hidden{}_{}.pkl'.format(cluster_id, rnn_dim, (count - 1))
...
if __name__ == "__main__":
    ...
    for line in lines:
        ...
        params_prime[param_name] = param_value
